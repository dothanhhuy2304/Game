...
public abstract class MoveLandController : MonoBehaviour
{
    ...
    protected void MoveLandNormalWithAnimation(Transform startPosition, Vector2 endPosition, float timeEndActions, int loop,Animator animator,string anim1,string anim2)
    {
